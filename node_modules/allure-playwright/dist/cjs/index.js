        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              ...
              attachmentTargets = (_this$attachmentTarge3 = this.attachmentTargets.get(test.id)) !== null && _this$attachmentTarge3 !== void 0 ? _this$attachmentTarge3 : [];
              targetIndex = 0;
              _iterator2 = _createForOfIteratorHelper(result.attachments);
              _context.p = 1;
              _iterator2.s();
            case 2:
              ...
              stepInfo = targetIndex < attachmentTargets.length ? attachmentTargets[targetIndex++] : undefined;
              if (!isRuntimeMessage) {
                _context.n = 4;
                break;
              }
